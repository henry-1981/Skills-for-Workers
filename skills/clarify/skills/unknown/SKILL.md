...
description: >
  ...
  Triggers: known unknown, 4분면 분석, blind spots, 뭘 놓치고 있지,
  뭘 모르는지 모르겠어, 전략 점검, 전략 분석, assumption check,
  가정 점검, quadrant analysis, what am I missing, 사각지대.
  For requirement clarification use clarify-vague; for content-vs-form use clarify-metamedium.
---
