---
name: nda-triage
origin: "Forked from anthropics/knowledge-work-plugins (Apache 2.0) — legal/skills/nda-triage"
description: >
  Screen incoming NDAs and classify as GREEN/YELLOW/RED.
  Triggers: NDA review, NDA triage, NDA screening,
  비밀유지계약, NDA 검토, NDA 분류, 계약서 검토
---
