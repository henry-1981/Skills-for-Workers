...
export const PURPOSE_PROFILES: PurposeProfile[] = [
  {
    ...
    presets: ['kr-impact-dark', 'bold-signal', 'electric-studio', 'neon-cyber'],
  ...
  },
  {
    ...
    presets: ['kr-clean-white', 'swiss-modern', 'paper-ink', 'electric-studio'],
  ...
  },
  {
    ...
    presets: ['bold-signal', 'notebook-tabs', 'electric-studio'],
  ...
  },
  {
    ...
    presets: ['kr-corporate-navy', 'swiss-modern', 'paper-ink', 'notebook-tabs'],
  ...
  },
  {
    ...
    presets: ['kr-corporate-navy', 'notebook-tabs', 'swiss-modern', 'paper-ink'],
  ...
  },
  {
    ...
    presets: ['kr-neon-stage', 'kr-impact-dark', 'neon-cyber', 'creative-voltage', 'bold-signal'],
  ...
  },
  {
    ...
    presets: ['paper-ink', 'swiss-modern', 'notebook-tabs'],
  ...
  },
  {
    ...
    presets: ['pastel-geometry', 'split-pastel', 'notebook-tabs'],
  ...
  },
  {
    ...
    presets: ['vintage-editorial', 'notebook-tabs', 'paper-ink'],
    layouts: ['two-split', 'asymmetric', 'hero-sub'],
  ...
  },
  {
    ...
    presets: ['kr-warm-coral', 'dark-botanical', 'vintage-editorial', 'split-pastel'],
  ...
  },
  {
    ...
    presets: ['kr-blue-gradient', 'notebook-tabs', 'pastel-geometry', 'swiss-modern'],
  ...
  },
  {
    ...
    presets: ['terminal-green', 'neon-cyber', 'swiss-modern'],
  ...
  },
  {
    ...
    presets: ['creative-voltage', 'split-pastel', 'dark-botanical'],
  ...
  },
  {
    ...
    presets: ['kr-elegant-serif', 'dark-botanical', 'bold-signal', 'creative-voltage'],
  ...
  },
  {
    ...
    presets: ['pastel-geometry', 'notebook-tabs', 'split-pastel'],
    layouts: ['three-equal', 'table-grid', 'two-split'],
  ...
  },
  {
    ...
    presets: ['swiss-modern', 'notebook-tabs', 'paper-ink'],
    layouts: ['table-grid', 'two-split', 'three-equal'],
    textRules: { maxWordsPerSlide: 50, minBodyFontPx: 28, titleStyle: 'statement' },
    emphasis: 'data',
  },
  {
    ...
    presets: ['vintage-editorial', 'split-pastel', 'notebook-tabs'],
  ...
  },
  {
    ...
    presets: ['vintage-editorial', 'electric-studio', 'dark-botanical'],
  ...
  },
  {
    ...
    presets: ['kr-gold-premium', 'swiss-modern', 'paper-ink', 'electric-studio'],
