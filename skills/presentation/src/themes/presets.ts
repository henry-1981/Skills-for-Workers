...
export const PRESETS: Record<string, StylePreset> = {
  ...
  'bold-signal': {
    ...
    fonts: {
      display: { family: 'Archivo Black', weight: '400', style: 'Regular' },
      body: { family: 'Space Grotesk', weight: '400', style: 'Regular' },
    },
  ...
  'electric-studio': {
    ...
    fonts: {
      display: { family: 'Manrope', weight: '800', style: 'ExtraBold' },
      body: { family: 'Manrope', weight: '400', style: 'Regular' },
    },
  ...
  'creative-voltage': {
    ...
    fonts: {
      display: { family: 'Syne', weight: '700', style: 'Bold' },
      body: { family: 'Space Mono', weight: '400', style: 'Regular' },
    },
  ...
  'dark-botanical': {
    ...
    fonts: {
      display: { family: 'Cormorant', weight: '600', style: 'SemiBold' },
      body: { family: 'IBM Plex Sans', weight: '300', style: 'Light' },
    },
  ...
  'notebook-tabs': {
    ...
    fonts: {
      display: { family: 'Bodoni Moda', weight: '700', style: 'Bold' },
      body: { family: 'DM Sans', weight: '400', style: 'Regular' },
    },
  ...
  'pastel-geometry': {
    ...
    fonts: {
      display: { family: 'Plus Jakarta Sans', weight: '700', style: 'Bold' },
      body: { family: 'Plus Jakarta Sans', weight: '400', style: 'Regular' },
    },
  ...
  'split-pastel': {
    ...
    fonts: {
      display: { family: 'Outfit', weight: '700', style: 'Bold' },
      body: { family: 'Outfit', weight: '400', style: 'Regular' },
    },
  ...
  'vintage-editorial': {
    ...
    fonts: {
      display: { family: 'Fraunces', weight: '700', style: 'Bold' },
      body: { family: 'Work Sans', weight: '400', style: 'Regular' },
    },
  ...
  'neon-cyber': {
    ...
    fonts: {
      display: { family: 'Rajdhani', weight: '700', style: 'Bold' },
  ...
  'terminal-green': {
    ...
    fonts: {
      display: { family: 'JetBrains Mono', weight: '700', style: 'Bold' },
      body: { family: 'JetBrains Mono', weight: '400', style: 'Regular' },
    },
  ...
  'swiss-modern': {
    ...
    fonts: {
      display: { family: 'Archivo', weight: '800', style: 'ExtraBold' },
      body: { family: 'Nunito', weight: '400', style: 'Regular' },
    },
  ...
  'paper-ink': {
    ...
    fonts: {
      display: { family: 'Cormorant Garamond', weight: '700', style: 'Bold' },
      body: { family: 'Source Serif 4', weight: '400', style: 'Regular' },
    },
