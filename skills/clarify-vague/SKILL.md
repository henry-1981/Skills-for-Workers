...
description: >
  ...
  Triggers: clarify requirements, refine requirements, 요구사항 명확히,
  요구사항 정리, 뭘 원하는 건지, make this clearer, spec this out,
  scope this, 요구사항 구체화, 모호한 요청.
  For strategy blind spots use clarify-unknown; for content-vs-form use clarify-metamedium.
---
